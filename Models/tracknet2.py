...
def trackNet( n_classes ,  input_height, input_width ): # input_height = 360, input_width = 640
	...
	#layer3
	x = MaxPooling2D((2, 2), strides=(2, 2), padding='same', data_format='channels_last' )(x)
	...
	#layer24
	x =  Conv2D( n_classes , (3, 3) , kernel_initializer='random_uniform', padding='same', data_format='channels_last' )(x)
	x = ( Activation('relu'))(x)
	x = ( BatchNormalization())(x)
